...
if __name__ == '__main__':
    ...
    # Save to file C_ells mean and std - Added SA
    print(o.output_dir)
    fname = man.get_filename('transfer_validation', o.output_dir)
    print(fname)
    np.savez(fname,
             input_cl = cl_in,
             error_input_cl = ecl_in,
             filtered_cl = cl_filt,
             error_filtered_cl = ecl_filt,
             decoupled_cl = cl_dec,
             error_decoupled_cl = ecl_dec)
